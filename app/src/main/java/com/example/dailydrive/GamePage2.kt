...
class GamePage2 : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_game_page2, container, false)
    ...
    private fun loadQuestion() {
        val questionResId = resources.getIdentifier(
            "question2_${currentQuestionIndex + 1}",  // Updated to reflect the specific game page 2
            "string",
        ...
        val answers = resources.getStringArray(
            resources.getIdentifier(
                "answers2_${currentQuestionIndex + 1}",  // Updated to reflect the specific game page 2
                "array",
                requireContext().packageName
            )
        )
    ...
    private fun checkAnswer() {
        val correctAnswerIndex = resources.getInteger(
            resources.getIdentifier(
                "correct_answer2_${currentQuestionIndex + 1}",  // Updated to fetch correct answer dynamically
                "integer",
                requireContext().packageName
            )
